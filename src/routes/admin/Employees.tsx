  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Select defaultValue="all"><option value="all">All Status</option><option value="active">Active</option><option value="on_leave">On Leave</option><option value="exited">Exited</option></Select>
      </div>
